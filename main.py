...
pygame.display.set_caption("Gravitational Slingshot Motion")
...
def main():
    ...
    while running:
        ...
        for obj in objects[:]:
            ...
            distance_to_planet = math.sqrt((obj.x - planet.x) ** 2 + (obj.y - planet.y) ** 2)
            collided = distance_to_planet <= (OBJ_SIZE + PLANET_SIZE)
